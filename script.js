...
// ===== 10. ACTUAL TELEGRAM SEND FUNCTION (NO GLITCH ANIMATION) =====
async function sendToTelegram() {
    ...
    // Start UI effects (NO GLITCH ANIMATION)
    playSound(600, 0.4, 'sawtooth');
    document.getElementById('loader-container').style.display = "block";
    // NO TERMINAL GLITCH ANIMATION: document.getElementById('terminalBox').classList.add('glitch-active');
    ...
    try {
        ...
        // Reset UI (NO GLITCH ANIMATION REMOVAL)
        setTimeout(() => {
            document.getElementById('loader-container').style.display = "none";
            // NO TERMINAL GLITCH ANIMATION REMOVAL: document.getElementById('terminalBox').classList.remove('glitch-active');
            pFill.style.width = "0%";
